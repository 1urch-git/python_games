...
STATES = ['California', 'Florida', 'Texas', 'New York', 'Georgia', 'North Carolina', 'Pennsylvania', 'Ohio', 'Illinois', 'Michigan']
NOUNS = ['Athlete', 'Clown', 'Shovel', 'Paleo Diet', 'Doctor', 'Parent', 'Cat', 'Dog', 'Chicken', 'Robot', 'Video Game', 'Avocado', 'Plastic Straw', 'Serial Killer', 'Telephonic Psychic']
PLACES = ['House', 'Attic', 'Workplace', 'Donut Shop', 'Bank Deposit Box', 'School', 'Basement', 'Apocalypse Bunker']
...
def main():
    ...
    website = random.choice(['wobsite.com', 'blag', 'Facebuuk', 'Googles', 'Facesbook', 'Tweedie', 'Pastagram'])
